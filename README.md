...
- ['티스토리 개발 블로그'](https://creative.yuziwoo.com/) : 공부 기록 <br/>처음 개발에 발을 디딜땐 엑셀에, 그 다음엔 노션에 정리를 했고, 이젠 저만의 블로그를 준비 중입니다.
